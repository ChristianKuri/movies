    ...
    <div className="border-b border-gray-800 movie-info">
      <div className="container flex flex-col px-4 py-16 mx-auto md:flex-row">
          ...
          <ul className="flex items-center mt-4">
            {actor.external_ids.facebook_id && (
              <li>
                ...
                >
                  <svg
                    className="w-6 text-gray-400 fill-current hover:text-white"
                    viewBox="0 0 448 512"
                  >
        ...
        <div className="md:ml-24">
          <h2 className="mt-4 text-4xl font-semibold md:mt-0">{actor.name}</h2>
          ...
          {actor.birthday && (
            <div className="flex flex-wrap items-center mt-4 text-sm text-gray-400">
              ...
              <span className="ml-2">
                {actor.birthday} ({getAge(actor.birthday)} years old) in{' '}
